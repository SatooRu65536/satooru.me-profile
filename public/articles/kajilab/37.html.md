...
updated_at: '2024-01-24T21:13:40+09:00'
published: true
number: 37
---
...
### 元データ
#### 加速度
<img width="621.36" alt="acc.png (73.9 kB)" src="/images/articles/37/a06c94c3-a7ee-41c6-9b2a-831fb461e4ca.png">

<img width="612" alt="norm.png (68.0 kB)" src="/images/articles/37/a567cc64-b4b3-4cf6-a775-2ebd078e7042.png">
...
#### 角速度, 角度
<img width="627.84" alt="gyro.png (45.5 kB)" src="/images/articles/37/f542fc96-2e01-4193-b1dd-8067cb0d89f4.png">

<img width="627.84" alt="rotate.png (56.2 kB)" src="/images/articles/37/4f5ab9e6-4664-411f-b02e-435c7ecf781b.png">


#### 姿勢推定結果
<img width="621.36" alt="pos.png (49.3 kB)" src="/images/articles/37/2b45d695-e99b-4b82-bd6f-aeaba0c49852.png">

うまくいっているように見えるが、角速度のメリットが分かりづらい


#### 加速度だけを使用した姿勢推定
<img width="621.36" alt="pos_from_acc.png (61.5 kB)" src="/images/articles/37/fbdb5137-5d18-4504-8073-0f23447c1bf0.png">



#### 世界座標系に変換した加速度
<img width="621.36" alt="word_coordinates.png (50.5 kB)" src="/images/articles/37/82be1c47-776d-4abd-ac8c-d8a4f453f4b9.png">
...
#### 加速度だけを使用した姿勢推定
<img width="612" alt="run_accpos.png (67.0 kB)" src="/images/articles/37/d9ec249e-9804-4394-a093-9ea7fdcc96db.png">

#### 相補フィルターを用いた姿勢推定
<img width="614.16" alt="run_pos.png (43.5 kB)" src="/images/articles/37/1a41218f-22b3-4547-89f5-a231039a0bb2.png">
...
### カルマンフィルタを用いた姿勢推定結果
<img width="591.84" alt="kalman_sample.png (46.1 kB)" src="/images/articles/37/bbaad505-7187-4b71-bd8d-05e893e8517a.png">
...
## 余談
### お月見どろぼう
<img width="45%" alt="otukimi.jpg (3.1 MB)" src="/images/articles/37/81295248-0ca7-4124-abb1-d7bacf5359e0.jpg">

<img width="45%" alt="okasi.jpg (5.2 MB)" src="/images/articles/37/fda46c9f-9607-4f15-b14b-074a2d40d98b.jpg">
